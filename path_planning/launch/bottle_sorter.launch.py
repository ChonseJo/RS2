...
def launch_setup(context, *args, **kwargs):
    ...
    kinematics_params = PathJoinSubstitution(
        [FindPackageShare(description_package), "include", "config", ur_type, "default_kinematics.yaml"]
    )
    physical_params = PathJoinSubstitution(
        [FindPackageShare(description_package), "include", "config", ur_type, "physical_parameters.yaml"]
    )
    visual_params = PathJoinSubstitution(
        [FindPackageShare(description_package), "include", "config", ur_type, "visual_parameters.yaml"]
    )
    ...
    robot_description_content = Command(
        [
            ...
            " ",
            PathJoinSubstitution([FindPackageShare(description_package), "include", "urdf", description_file]),
            " ",
...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            "description_package",
            default_value="ur3_bottle_sorter",
